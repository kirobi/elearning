                ...
                <div class="hero-unit-3">
                    <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                        ...
                        if (isset($_POST['save1'])) {
                            ...
                            $error_query = mysql_query("select * from teacher_student where teacher_id='$teacher_id' and student_id='$student_id'") or die(mysql_error());
                            $error_row = mysql_fetch_array($error_query);
                            $count = mysql_num_rows($error_query);
                            ...
                            if ($count > 0) {
                                ...
                                mysql_query("insert into teacher_student (teacher_id,student_id) values('$teacher_id','$student_id')") or die(mysql_error());
