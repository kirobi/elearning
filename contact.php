        ...
        <div class="row-fluid">
            ...
            <div class="span9">
                ...
                <div class="hero-unit-3">
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            <div class="alert alert-success">  Main Campus </div>

                            <div class="row-fluid">
                                <div class="span6">

                                    <p><i class="icon-circle"></i>&nbsp;School Lab  - 712-0848</p>
                                    <p><i class="icon-circle"></i>&nbsp;Accounting Office- 495-5560</p>
                                    <p><i class="icon-circle"></i>&nbsp;Principals Office - 495-4064(telefax)</p>
