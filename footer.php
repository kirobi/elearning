...
<div class="navbar  navbar-inverse">
    <div class="navbar-inner">
        <div class="footerindex">
            <center>&nbsp;Learners E-Learning System Developed by C025-0157/2010: John Njoroge Kirobi</center>
        </div>
        <!-- modal -->
        <!-- mission -->
        <div id="mission" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="alert alert-info"><strong>Learners Mission</strong></div>
                <p>
        ...
        <div id="vision" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="alert alert-info"><strong>Learners Vision</strong></div>

                <p>Learners ExCELS: Excellence, Competence, and Educational Leaderhip in Science and Technology.</p>
