                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    ...
                                    <td width="100">
                                        ...
                                        <a el="tooltip"  title="Edit Department" id="e<?php echo $dep_id; ?>" href="edit_department.php<?php echo '?id='.$dep_id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;</a>
                                    </td>
                                    <!-- user delete modal -->
