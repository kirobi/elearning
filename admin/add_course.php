                                ...
                                <li class="span7">
                                    <div class="thumbnail">
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            mysql_query("insert into course (cys,department,major) values ('$cc','$cd','$major')") or die(mysql_error());
                                            mysql_query("INSERT INTO history (data,action,date,user)VALUES('$f $l', 'Add Course', NOW(),'Admin')")or die(mysql_error());
