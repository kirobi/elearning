                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="example">
                                ...
                                <tbody>
                                    ...
                                    <td width="100">
                                        ...
                                        <a rel="tooltip"  title="Edit Subject" id="e<?php echo $subject_id; ?>" href="edit_subject.php<?php echo '?id='.$subject_id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;</a>
                                    </td>
                                    <!-- user delete modal -->
