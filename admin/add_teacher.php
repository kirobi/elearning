                    ...
                    <div class="span12">
                        <div class="hero-unit-3">
                            ...
                            if (isset($_POST['save'])) {
                                ...
                                mysql_query("insert into teacher (username,password,firstname,lastname,middlename,department,location)
								values ('$username','$password','$firstname','$lastname','$middlename','$department','$location')") or die(mysql_error());
								mysql_query("INSERT INTO history (data,action,date,user)VALUES('$f $l', 'Add Teacher', NOW(),'Admin')")or die(mysql_error());
