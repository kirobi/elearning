                                ...
                                <li class="span7">
                                    <div class="thumbnail">
                                        ...
                                        if (isset($_POST['save'])) {
                                            ...
                                            mysql_query("insert into sy (sy) values ('$sy')") or die(mysql_error());
											mysql_query("INSERT INTO history (data,action,date,user)VALUES('$f $l', 'Add School Year', NOW(),'Admin')")or die(mysql_error());
