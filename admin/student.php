                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td width="100">
                                            ...
                                            <a rel="tooltip"  title="Edit Course" id="e<?php echo $student_id; ?>" href="edit_student.php<?php echo '?id='.$student_id; ?>" class="btn btn-success"><i class="icon-pencil icon-large"></i>&nbsp;</a>
                                    </td>
                                        <!-- user delete modal -->
