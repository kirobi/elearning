                    ...
                    <form class="form-horizontal" method="POST">
                        ...
                        <div class="control-group">
                            ...
                            if (isset($_POST['save_subject'])) {
                                ...
                                $result = mysql_query("select * from teacher_suject where teacher_id='$session_id' and subject_id='$subject'") or die(mysql_error());
                                ...
                                if ($count > 0) {
                                    ...
                                    mysql_query("insert into teacher_suject (subject_id,teacher_id) values('$subject','$session_id')") or die(mysql_error());
                                    header('location:teacher_subject.php');
									mysql_query("INSERT INTO history (data,action,date,user)VALUES('$f $l', 'Add Subject', NOW(),'Teacher')")or die(mysql_error());
                                }
                            }
                            ?>
